...
Today we are going to prove the following theorem (mostly a sketch -- the details are homework).
\begin{theorem}
...
We have two tools that we might use to fix this: Mayer-Vietoris and Seifert-van Kampen.
\begin{lemma}
    Mapping cones are homotopy invariant. More precisely, given
    \begin{equation*}
        \begin{tikzcd}
        ...
        \end{tikzcd}
    \end{equation*}
    we have that $\cone f\simeq \cone f'$.
\end{lemma}
\begin{proof}
    Recall that $\cone f = *\sqcup_{X\times\{0\}}X\times[0,1]\sqcup_{X\times\{1\}}Y$.
...
\begin{definition}
    ...
    \begin{equation*}
        \begin{tikzcd}
            X_\bullet|& \coprod_{n\geq 0}X_n\times \Delta^n\lar & \coprod_{[m]\to[l]}X_l\times \Delta^m % draw in the two arrows here
        \end{tikzcd}
    \end{equation*}
\end{definition}
...
\begin{proof}[Proof outline]
    ...
    \begin{equation*}
        \begin{tikzcd}
            sk_n X_\bullet | & \coprod_{k\leqslant n}X_k\times \Delta^k & \coprod_{[m]\to[l]; m,l\leqslant n}X_l\times \Delta^m
        \end{tikzcd}
    \end{equation*}
    ...
    \begin{equation*}
        \begin{tikzcd}
            L_nX\times \Delta^n\coprod_{L_n X\times\partial \Delta^n} X_n\times\partial\Delta^n \rar & sk_{n-1} X_\bullet|\dar \\
