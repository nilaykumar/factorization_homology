...
\begin{equation*}
    \begin{tikzcd}
        ...
        \mathsf{sSet}\ar[ur, dashed]%{\mathsf{sd}=\mathsf{LKan} \mathsf{nd}}
    \end{tikzcd}
\end{equation*}
In other words,
\begin{equation*}
...
\begin{proof}
    ...
    given by
    %\begin{equation*}
    %    \text{image}(g)\hookrightarrow [p]\times[q] \leftmapsto T \xrightarrow{g} [p]\times[q].
    %\end{equation*}
    \marginnote{Fix this}
    Hence
    \begin{equation*}
...
\begin{theorem}[Ayala, Francis - Poincar\'e/Koszul duality]
